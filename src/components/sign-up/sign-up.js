    ...
    return (
      <div className='sign-up'>
        ...
        <form className='sign-up-form' onSubmit={this.handleSubmit}>
          ...
          <FormInput type='email' name='email' value={email} onChange={handleChange} label='Display Email' required ></FormInput>
          <FormInput type='password' name='password' value={password} onChange={handleChange} label='Display Password' required ></FormInput>
